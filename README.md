...
<p align="center"> 
<b>Konnichiwa Senpai, I am "Makima" an Opensource WhatsApp bot made by <a href="https://github.com/Pelpav">Pelpav</a> to do everything that's beyond imagination with highest <b>Features</b> and <b>Stability</b> and <b>Compatibility</b> built with Baileys Multi Device support.
...
- Read [PublicKeys.md](https://github.com/Pelpav/Makima-V2/blob/main/PublicKeys.md) to use our `provided public keys` if you are lazy to create your own. We have already provided everying you need to run the bot.
